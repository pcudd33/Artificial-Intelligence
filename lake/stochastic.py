...
# Settings
epsilon = 0.99  # at the beginning we will be intentionally exploring 10% of the time
alpha = 0.99
gamma = 0.99    # we care about future rewards a little bit so eventually we will find the terminal state

# Q-values
Q = {(s, a): 0.0 for s in states for a in actions}

# Schedule
batches = list(range(200))    # outer iterations
episodes = list(range(100))   # inner iterations
